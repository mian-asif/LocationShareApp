  ...
  Future<void> addNotification(receiverNumber) async {
    ...
    return FirebaseFirestore.instance
        ...
        .add({
          ...
          'status': false,
          'msg':
              ' just accepted your friend request. Now you can share location with them. ',
          ...
          SizedBox(
            ...
            child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  ...
                  .where('receiver_numberWithoutSpace', isEqualTo: myPhone)
                  .where('request_status', isEqualTo: false)
                  .snapshots(),
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return requestStatus == false
                            ? friendRequestCard(context,
                                buttonName: 'Accept',
                                name: senderName, onPressed: () {
