...
class _FoodRequestScreenState extends State<FoodRequestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return loaging? const Scaffold(
      ...
      }, backgroundColor:  documentsLenth < 4 ? const Color(0xFF378C5C) : Colors.white,iconColor:  documentsLenth<4? Colors.white : const Color(0xFF378C5C)),
      body: Padding(
                      ...
                      physics: const BouncingScrollPhysics(),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return  DateTime.now().isAfter(deleteTime)? Container() : Padding(
                            ...
                            child:
                            // seekerUid == myUid.toString()?
                            foodRequestCard(context,seekerName:seekerName,requestDate:date,viewPersons: personView.toString(),photoURL: photoURL,onPress: (){
