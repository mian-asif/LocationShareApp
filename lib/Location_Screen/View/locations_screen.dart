      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(left: cWidth * 0.03, top: 20),
              child: Text(
                'Locations',
                style: TextConstants.pageTittle,
              ),
            ),
            //'A place to see any locations received'
            Padding(
              padding:
                  EdgeInsets.only(left: cWidth * 0.03, top: cHeight * 0.01),
              child: Text(
                'A place to see any locations received',
                style: TextConstants.brownText,
              ),
            ),
            SizedBox(
              height: cHeight * 0.7,
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          var userlocationlatitude =
                              (doc['userlocationlatitude']);
                          var userlocationlongitude =
                              (doc['userlocationlongitude']);
                          var docID = (doc.id);
                          return InkWell(
                              onTap: () {
                                Get.to(
                                  ...
                                  arguments: [
                                    ...
                                    cUserserlocationlatitude,
                                    cUserserlocationlongitude,
                                    _position,
                                    locationTag
                                  ],
                                );
