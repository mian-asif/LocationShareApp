...
import '../../ChangePasswordScreen/View/change_password_screen.dart';
import '../../CustomWidgets/custom_widgets.dart';
import '../../FoodDonationHistory/food_donation_history.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  static const LatLng _kMapCenter = LatLng(31.4661398, 74.3704655);
  ...
  Future<void> displayTextInputDialog(BuildContext context) async {
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Text(
                'Share your location with a tag to hide your identity'),
            content: TextField(
              onChanged: (value) {
                setState(() {
                  // valueText = value;
            ...
            actions: <Widget>[
              TextButton(
                child: const Text('CANCEL',
                    style: TextStyle(color: Color(0xff0091C4))),
                onPressed: () {
                  setState(() {
            ...
            actions: <Widget>[
              ...
              TextButton(
                ...
                onPressed: () {
                  setState(() {
                    // codeDialog = valueText;
                    Get.to(const ShareLocationWithFriends(), arguments: [
      ...
      child: Scaffold(
          drawer: Drawer(
            ...
            child:
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.only(
                              top: cHeight * 0.07, left: cWidth * 0.08),
                          child: Column(
                        ...
                        Padding(
                          padding:
                              EdgeInsets.only(left: cWidth * 0.6, bottom: 0),
                          child: IconButton(
                              onPressed: () {
                                Get.back();
                              },
              ...
              Padding(
                padding: EdgeInsets.only(left: 18.0, top: cHeight * 0.05),
                child:
                    buttonName(context, buttonName: 'History', onPressed: () {
                  Get.to(const FoodDonationHistory());
                }, icon: Icons.history),
              ),
              Padding(
                padding: EdgeInsets.only(left: 18.0, top: cHeight * 0.0),
                child: buttonName(context, buttonName: 'Change Password',
                    onPressed: () {
                  Get.to(const ChangePasswordScreen(), arguments: [myEmail]);
                }, icon: Icons.person),
              ),
              Padding(
                padding: EdgeInsets.only(left: 18.0, top: cHeight * 0.25),
                child: buttonName(context, buttonName: 'Logout', onPressed: () {
                  logout();
                }),
              ),
            ]),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: const Icon(Icons.share,
                            color: Color(0XFFFF5566), size: 35),
                      ),
                    ),
                  ),
                ),
                  ...
                  child: FloatingActionButton(
                    ...
                    child: loadingformap
                        ...
                        : Icon(Icons.my_location,
                            color: Color(0XFF0091C4), size: 35),
                  ),
                ),
              ],
            ),
