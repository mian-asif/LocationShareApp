...
class _ContactsScreenState extends State<ContactsScreen> {
    ...
    if (await FlutterContacts.requestPermission()) {
      ...
      for (int i = 0; i < mobileContacts!.length; i++) {
        setState(() {
          ...
          allPhonesData.add(mobileContacts![i]
              .phones
              .first
              .number
              .replaceAll(RegExp(' +'), ''));
    ...
    FirebaseFirestore.instance
      ...
      querySnapshot.docs.forEach((userData) {
        setState(() {
          ...
          buttonPressed = userData['buttonPressed'];
        });
      });
    });
  }
  ...
  getFriendData() {
    FirebaseFirestore.instance
        .collection('friends')
        .where('combNumbers', arrayContainsAny: [myPhone])
        .get()
        .then((QuerySnapshot querySnapshot) {
          querySnapshot.docs.forEach((userData) {
            setState(() {
  ...
  getFirebaseNumbers() {
    FirebaseFirestore.instance
        ...
        .where('phone', isNotEqualTo: myPhone)
        .get()
        .then((QuerySnapshot querySnapshot) {
            ...
            ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      String num = (mobileContacts![index].phones.isNotEmpty)
                          ...
                          : "--";
                      bool numberExist = firebasePhoneNumber
                          .contains(num.replaceAll(RegExp(' '), ''));
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: CircleAvatar(
                                        ...
                                        child: (mobileContacts![index].photo ==
                                                null)
                                            ? const CircleAvatar(
                                    ...
                                    Padding(
                                        ...
                                        child: buttonPressed==null   ? ElevatedButton(
